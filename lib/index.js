 ...
 * @return {Object}
 */
MySQLPool.prototype.model = function (name) {
  if (!this._models[name]) {
    debug('create model: %s', name);
    this._models[name] = createModel(this, name);
  }
 ...
 * @return {String}
 */
MySQLPool.prototype.parseCondition = function (w) {
  return parseCondition(w);
};
